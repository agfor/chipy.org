...
# from https://github.com/man-group/dtale/blob/master/docs/EMBEDDED_DJANGO.md
...
# from an old version of werkzeug
def pop_path_info(environ: "WSGIEnvironment", charset: str = "utf-8", errors: str = "replace"):
...
def peek_path_info(environ: "WSGIEnvironment", charset: str = "utf-8", errors: str = "replace"):
